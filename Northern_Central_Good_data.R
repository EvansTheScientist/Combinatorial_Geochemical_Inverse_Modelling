...
## from median concentration of all groundwater samples in the northern zone
ewat <- c("SOLUTION 1",
          "units mol/kgw",
          "temp 25",
          "pressure 1",
...
## Our target (Central zone) is the second elemental concentration of the res list
target <- res[[2]]$tot
cvec <- target$molal
...
## Creating a vector of the median concentration of the northern zone solution
