...
### Initial solution coded as a standard PHREEQC input solution: 47% evaporation of Rainwater composition
ewat <- c("SOLUTION 1",
          "units mol/kgw",
          "temp 25",
          "pressure 1",
...
## workhorse function to run simulations. NOTE:The
#database has been hard coded into it!
...
### Added Code for ploting in decreasing order of the mineral frequency #################
...
## Original bar plot for the mineral frequency ##################################################
